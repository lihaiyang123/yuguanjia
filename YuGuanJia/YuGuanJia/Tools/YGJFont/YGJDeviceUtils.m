...
+ (BOOL)is65InchScreen {
    if (is65InchScreen < 0) {
        ...
        is65InchScreen = (DEVICE_WIDTH == self.screenSizeFor65Inch.width && DEVICE_HEIGHT == self.screenSizeFor65Inch.height && ([[YGJDeviceUtils deviceModel] isEqualToString:@"iPhone11,4"] || [[YGJDeviceUtils deviceModel] isEqualToString:@"iPhone11,6"])) ? 1 : 0;
    }
