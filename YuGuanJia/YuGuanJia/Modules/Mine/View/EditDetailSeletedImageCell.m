...
@interface EditDetailSeletedImageCell ()<TZImagePickerControllerDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
{
...
@implementation EditDetailSeletedImageCell
...
-(void)update {
    ...
    if (self.rowDescriptor.value && ![self.rowDescriptor.tag isEqualToString:@"kGoodsCover"]) {
        ...
        NSData *data = [NSData dataWithContentsOfURL:[NSURL URLWithString:self.rowDescriptor.value]];
...
//        layout.minimumInteritemSpacing = 5;
        ...
        [_picCollectionView registerClass:[EditSelectImageCollectionViewCell class] forCellWithReuseIdentifier:[EditSelectImageCollectionViewCell className]];
...
{
    EditSelectImageCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:[EditSelectImageCollectionViewCell className] forIndexPath:indexPath];
...
#pragma mark - deleteRequest /app/goodsPics/delete
- (void)goodsPicsDeleteRequestByID:(NSString *)idStr {
...
//        [self.dataArr addObject:image];
//        [UDAAPIRequest uploadImagesUrl:@"/image/uploadImg" parameters:nil name:@"file" images:self.dataArr fileNames:nil imageScale:1 imageType:@"png" progressBlock:^(CGFloat value) {
//
...
//                self.rowDescriptor.value = requestModel.result[@"filePath"];
//                [self.picCollectionView reloadData];
//
//            }else{
//                [SVProgressHUD dismiss];
...
- (void)imagePickerController:(TZImagePickerController *)picker didFinishPickingPhotos:(NSArray<UIImage *> *)photos sourceAssets:(NSArray *)assets isSelectOriginalPhoto:(BOOL)isSelectOriginalPhoto infos:(NSArray<NSDictionary *> *)infos {
    ...
    [SVProgressHUD show];
    @weakify(self);
    [UDAAPIRequest uploadImagesUrl:@"/image/uploadImg" parameters:nil name:@"file" images:_dataArr fileNames:nil imageScale:1 imageType:@"png" progressBlock:^(CGFloat value) {
