...
export default {
  ...
  data(){
    return {
      selected:"",
      options: [
        { text : '单据模版', value: 'https://picture.cqzhong.cn/danjumoban.xlsx' },
  ...
  mounted() {
    ...
    // this.$nextTick(() => {
          $(function () {
            ...
            LuckyExcel.transformExcelToLuckyByUrl('https://picture.cqzhong.cn/danjumoban.xlsx', '单据模版', (exportJson, luckysheetfile) => {
